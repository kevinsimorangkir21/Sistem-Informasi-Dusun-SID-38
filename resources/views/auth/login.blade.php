                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="d-flex justify-content-center py-4">
                                <a href="{{ url('/') }}" class="logo d-flex align-items-center w-auto">
                                    <img src="{{ url('/assets/img/r.jpg') }}" alt="logo_kom.png">
                                    <span class="d-none d-lg-block">Dusun 3B</span>
                                </a>
                            </div><!-- End Logo -->
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="pt-4 pb-2">
                                        ...
                                        <p class="text-center small">Masukan Email & Kata Sandi Anda Dengan Benar Untuk Masuk.</p>
                                    </div>
                                    ...
                                    <form class="row g-3 needs-validation" action="{{ url('/login') }}" method="POST">
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="input-group has-validation">
                                                <input type="email" name="email" class="form-control" id="youremail" placeholder="user@gmail.com" required>
